...
import ImagesLinksModal from './ImagesLinkModal';
import AboutCompanyModal from './AboutCompanyModal';
import ModifyApplicationsModal from './ModifyApplicationsModal';
import DeleteModal from './DeleteModal';

const CompanyModAccount = () => {
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={styles.buttonContent}>
          ...
          <TouchableOpacity style={[styles.settingsButton, { width: itemWidth }]} onPress={handleProfileModifyPress}>
            ...
            <TouchableOpacity style={[styles.settingsButton, { width: itemWidth }]} onPress={() => navigation.navigate("FieldsModal")}>
              <LinearGradient
                colors={['rgba(84, 150, 238, 1)', 'rgba(0, 99, 230, 1)']}
                style={styles.linearGradient}
                start={{ x: 0, y: 0 }}
            ...
            <TouchableOpacity style={[styles.settingsButton, { width: itemWidth }]} onPress={() => navigation.navigate("TitlesModal")}>
              <LinearGradient
                colors={['rgba(84, 150, 238, 1)', 'rgba(0, 99, 230, 1)']}
                style={styles.linearGradient}
                start={{ x: 0, y: 0 }}
...
export default CompanyModAccount;