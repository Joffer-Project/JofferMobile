...
const AboutScreen = () => {
  ...
  const handleAddLink = () => {
    ...
    setLinks([...links, 'https://personalproblems.com']);
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={styles.linksContainer}>
            ...
            {links.map((link, index) => (
              <View key={index} style={styles.linkItem}>
                <TouchableOpacity style={styles.removeButton} onPress={() => handleRemoveLink(index)}>
                  <Ionicons name="remove-circle-outline" size={24} color="#0C6BE8" />
                </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.addLinkButton} onPress={handleAddLink}>
            <Ionicons name="add-circle-outline" size={24} color="#0C6BE8" />
