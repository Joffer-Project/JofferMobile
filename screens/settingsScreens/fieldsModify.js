...
const FieldsScreenModify = ({route}) => {
    ...
    >
      ...
      <LinearGradient
        ...
        <View style={styles.welcomeContainer}>
          <Text style={styles.welcomeText}>Industries</Text>
          <Text style={[styles.welcomeText, { fontSize: 16 }]}>Choose the industries that align best with where your company holds a place </Text>
        </View>
...
export default FieldsScreenModify;
